...
Internal document-intelligence prototype for extracting structured fields from OCR text, validating invoice annotations, exposing extraction through a REST API, and reviewing results in a lightweight Streamlit interface.
...
- Added a FastAPI endpoint and Streamlit review interface around the extraction function.
...
- `app/dashboard.py` — simple review UI
